...
<html>
    ...
    <body>
        ...
        <div id="show-thing" class="content scaffold-show" role="main">
            ...
            <g:form resource="${this.thing}" method="DELETE">
                <fieldset class="buttons">
                    <g:link class="edit" action="edit" resource="${this.thing}"><g:message code="default.button.edit.label" default="Edit" /></g:link>
